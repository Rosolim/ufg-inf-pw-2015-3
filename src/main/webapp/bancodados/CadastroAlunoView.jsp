			...
			<div class="modal-dialog" style="margin-bottom: 0">
				<div class="modal-content">
					...
					<div class="panel-body">
						<form role="form" action="CadastroAluno">
							<fieldset>
								<div class="form-group">
									<input class="form-control" placeholder="Matrícula"
										name="matricula" type="text" value="${param.matricula}">
								</div>
								<div class="form-group">
								...
								<input type="submit" class="btn btn-sm btn-success"
									name="incluir" value="Incluir"> <input type="submit"
									class="btn btn-sm btn-success" name="editar" value="Editar">
							</fieldset>
						</form>
						<br>
						<%
						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									...
									<td><%=a.getCpf()%></td>
									<td><a
										href="CadastroAluno?matricula=<%=a.getMatricula()%>&nome='<%=a.getNome()%>'&fone='<%=a.getFone()%>'&cpf='<%=a.getCpf()%>'">Alterar</a></td>
									<td><a
										href="ExcluirAluno?matricula=<%=a.getMatricula()%>&nome='<%=a.getNome()%>">Excluir</a></td>
								</tr>
								<%
									}
									}
